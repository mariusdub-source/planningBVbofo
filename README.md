...
Dans la page **Données** (mode administrateur), un encadré **Pop-In** permet :

- de rédiger le message affiché après la connexion d'un salarié ou de l'administrateur ;
- de prévisualiser la fenêtre ;
- de masquer complètement la Pop-In avec une case à cocher.

La fenêtre peut être fermée par l'utilisateur.
