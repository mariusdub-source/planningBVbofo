            ...
            return (
              <section className="card" style={{ maxWidth: 560, margin: '0 auto' }}>
                <div className="section-title">
                  <div>
                    <h2>Mon pointage</h2>
                    <p>{employees[employeeIndex]} — saisie déclarative des horaires réellement effectués.</p>
                  </div>
                  <span className="badge">Compté</span>
                </div>

                <div style={{ display: 'grid', gap: 16 }}>
                  <label>Date
                    <input type="date" value={selectedDate} onChange={(e) => { setSelectedDate(e.target.value); setPointageSaved(false); }} />
                  </label>
                  ...
                  <div style={{ padding: 14, borderRadius: 10, background: '#ecfdf5', border: '1px solid #a7f3d0' }}>
                    <strong style={{ display: 'block', marginBottom: 10, color: '#065f46' }}>Pause déclarée</strong>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, padding: '14px 0', borderTop: '1px solid #dbe3ec', borderBottom: '1px solid #dbe3ec' }}>
                    <strong>Total déclaré</strong>
                    <strong style={{ fontSize: 26, color: '#0f766e' }}>{formatHours(shiftMinutes(shift))}</strong>
                  </div>

                  <button type="button" onClick={() => setPointageSaved(true)}>Enregistrer ma journée</button>
                  {pointageSaved && <div style={{ padding: 12, borderRadius: 8, background: '#ecfdf5', color: '#065f46', fontWeight: 700, textAlign: 'center' }}>Journée enregistrée dans les heures comptées.</div>}
                </div>
              </section>
            );
          })()}
