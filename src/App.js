            ...
            return (
              <section className="card pointage-shell">
                ...
                <div className="pointage-body">
                  ...
                  <button className="pointage-save" type="button" onClick={() => setPointageSaved(true)}>✓ Enregistrer ma journée</button>
                  ...
                  <div className="pointage-month">
                    ...
                    <div className="pointage-calendar">
                      ...
                      {pointageMonthDays.map((calendarDate) => {
                        ...
                        const storedShift = actualData?.[weekKeyFromDate(calendarDate)]?.[employeeIndex]?.[dayKeyFromDate(calendarDate)];
                        const hasPointage = Boolean(storedShift && (storedShift.start || storedShift.end || storedShift.breakStart || storedShift.breakEnd || storedShift.counter || storedShift.note));
