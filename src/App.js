        ...
        <>
          ...
          {activeView === 'global' && (
            <section className="card">
              <div className="section-title">
                <div>
                  <h2>Vue globale — {displayLongDate(selectedDateObject)}</h2>
                  <p>Planning journalier de l’ensemble des salariés, visible par tous pour connaître la répartition dans les guichets.</p>
                </div>
                <span className="badge">{employees.length} salariés</span>
              </div>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td className="total-cell">
                        {formatHours(employees.reduce((sum, _, employeeIndex) => sum + dayTotalForEmployee(employeeIndex, selectedDayKey), 0))}
                      </td>
                      <td />
                    </tr>
                  </tfoot>
