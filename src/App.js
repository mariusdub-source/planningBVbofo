...
function App() {
  ...
  }, [activeView, places, employees, data, weekKey, selectedDayKey]);
      ...
      {!canUsePlanning ? (
        ...
        <>
          ...
          <nav className="tabs">
            ...
            <button className={activeView === 'coverage' ? 'active' : ''} onClick={() => setActiveView('coverage')}>Couverture guichets</button>
          ...
          {activeView === 'coverage' && (
            <section className="card coverage-page">
              <div className="section-title coverage-page-title">
                <div>
                  <h2>Couverture des guichets</h2>
                  <p>{selectedDayLabel} {displayDate(selectedDateObject)} · plage horaire 07:00 → 23:00</p>
                </div>
                <span className="badge">Analyse des manques</span>
              </div>
