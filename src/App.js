...
function migrateShiftPresetPauses(storedPresets) {
  ...
  return presets.map((preset) => {
    const presetPause = pdfPauseTimesByShift[String(preset?.name || '').toLocaleLowerCase('fr-FR')];
    return presetPause ? { ...preset, ...presetPause } : withPdfPauseTimes(preset, preset?.name);
  });
}
