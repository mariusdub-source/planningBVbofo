              ...
              {globalMode === 'day' ? (
                ...
                <div className="table-wrap global-week-wrap">
                  <table className="compact-table global-week-table">
                    <thead>
                      <tr>
                        <th style={{ width: '90px', minWidth: '90px', maxWidth: '90px' }}>Salarié</th>
                    ...
                    <tbody>
                      {employees.map((employee, employeeIndex) => (
                        <tr key={employeeIndex}>
                          <th style={{ width: '90px', minWidth: '90px', maxWidth: '90px', paddingLeft: '8px', paddingRight: '8px' }}>{employee}</th>
                          {days.map((day) => {
                            const shift = getShift(data, weekKey, employeeIndex, day.key);
                            return (
