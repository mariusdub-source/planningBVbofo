          ...
          {activeView === 'skello' && (
            <section className="card" style={{ padding: 0, overflow: 'hidden' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, padding: '18px 20px', borderBottom: '1px solid #e5e7eb', flexWrap: 'wrap' }}>
                <div>
                  <h2 style={{ margin: 0 }}>Planning visuel — semaine du {displayDate(weekStart)}</h2>
                  <p style={{ margin: '5px 0 0', color: '#64748b' }}>Vue compacte inspirée des logiciels de planning : un salarié par ligne et un jour par colonne.</p>
                </div>
