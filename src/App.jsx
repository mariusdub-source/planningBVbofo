...
const POST_PRESETS = [
  { label: '', poste: '', start: '', end: '', pause: '', total: '' },
  { label: 'Bureau 2 — 9h00-13h00 / 14h00-17h30 — 7,5', poste: 'Bureau 2', start: '09:00', end: '17:30', pause: '01:00', total: '7,5' },
  { label: 'Bureau — 8h30-13h00 / 13h30-17h00 — 8,00', poste: 'Bureau', start: '08:30', end: '17:00', pause: '00:30', total: '8,00' },
  { label: 'Bureau 1 — 7h00-12h00 / 12h30-15h30 — 8', poste: 'Bureau 1', start: '07:00', end: '15:30', pause: '00:30', total: '8' },
  { label: 'Ouv Bureau — 7h30-12h00 / 12h30-16h00 — 8,00', poste: 'Ouv Bureau', start: '07:30', end: '16:00', pause: '00:30', total: '8,00' },
  { label: 'Bureau 3 — 11h30-14h00 / 15h00-20h30 — 8', poste: 'Bureau 3', start: '11:30', end: '20:30', pause: '01:00', total: '8' },
  { label: 'Repos', poste: 'repos', start: '', end: '', pause: '', total: '0' },
  { label: 'Max Renfort — 8h00-12h00 / 13h00-16h00 — 7', poste: 'Max Renfort', start: '08:00', end: '16:00', pause: '01:00', total: '7' },
  { label: 'Bureau — 10h00-13h00 / 14h00-19h00 — 8,00', poste: 'Bureau 10-19', start: '10:00', end: '19:00', pause: '01:00', total: '8,00' },
  { label: 'Renfort PG C — 8h00-14h00 — 6', poste: 'Renfort PG C', start: '08:00', end: '14:00', pause: '00:00', total: '6' },
  { label: 'Renfort Max — 8h00-13h00 — 5,00', poste: 'Renfort Max', start: '08:00', end: '13:00', pause: '00:00', total: '5,00' },
  { label: 'Max Ouv — 7h00-11h30 / 12h00-14h30 — 7', poste: 'Max Ouv', start: '07:00', end: '14:30', pause: '00:30', total: '7' },
  { label: 'PG C Marché — 8h00-13h00 / 14h00-15h15 — 6,25', poste: 'PG C Marché', start: '08:00', end: '15:15', pause: '01:00', total: '6,25' },
  { label: 'Max Ferm — 13h30-15h00 / 15h45-21h15 — 7,00', poste: 'Max Ferm', start: '13:30', end: '21:15', pause: '00:45', total: '7,00' },
  { label: 'Renfort Iss — 8h00-13h30 — 5,5', poste: 'Renfort Iss', start: '08:00', end: '13:30', pause: '00:00', total: '5,5' },
  { label: 'Issambres — 8h00-12h00 / 13h45-17h00 — 7,25', poste: 'Issambres', start: '08:00', end: '17:00', pause: '01:45', total: '7,25' },
  { label: 'PG Ég Jour — 8h00-14h00 — 6', poste: 'PG Ég Jour', start: '08:00', end: '14:00', pause: '00:00', total: '6' },
  { label: 'PG Église — 8h00-12h35 / 13h20-17h30 — 8,75', poste: 'PG Église', start: '08:00', end: '17:30', pause: '00:45', total: '8,75' },
  { label: 'Renfort PG C — 8h00-13h30 — 5,50', poste: 'Renfort PG C 13h30', start: '08:00', end: '13:30', pause: '00:00', total: '5,50' },
  { label: 'Marines — 8h00-14h00 — 6,00', poste: 'Marines', start: '08:00', end: '14:00', pause: '00:00', total: '6,00' },
  { label: 'Trop Soir — 16h00-20h00 / 20h20-23h15 — 6,92', poste: 'Trop Soir', start: '16:00', end: '23:15', pause: '00:20', total: '6,92' },
  { label: 'Trop Matin — 9h45-15h45 — 6,00', poste: 'Trop Matin', start: '09:45', end: '15:45', pause: '00:00', total: '6,00' },
  { label: 'Trop Apm — 15h20-20h20 — 5,00', poste: 'Trop Apm', start: '15:20', end: '20:20', pause: '00:00', total: '5,00' },
  { label: 'Aqua — 8h30-12h00 / 13h30-17h00 — 7', poste: 'Aqua', start: '08:30', end: '17:00', pause: '01:30', total: '7' },
  { label: 'Max Journée — 9h00-13h00 / 14h30-18h00 — 7,50', poste: 'Max Journée', start: '09:00', end: '18:00', pause: '01:30', total: '7,50' },
  { label: 'Max Apm — 14h30-17h00 / 18h00-22h30 — 7', poste: 'Max Apm', start: '14:30', end: '22:30', pause: '01:00', total: '7' },
  { label: 'Aqua — 9h45-12h00 / 13h30-17h15 — 6,00', poste: 'Aqua 9h45', start: '09:45', end: '17:15', pause: '01:30', total: '6,00' },
  { label: 'PG C Apm — 15h00-21h00 — 6', poste: 'PG C Apm', start: '15:00', end: '21:00', pause: '00:00', total: '6' },
  { label: 'Max Ouv — 7h20-12h00 / 12h30-15h20 — 7,50', poste: 'Max Ouv 7h20', start: '07:20', end: '15:20', pause: '00:30', total: '7,50' },
  { label: 'PG Ég Apm — 13h50-19h50 — 6', poste: 'PG Ég Apm', start: '13:50', end: '19:50', pause: '00:00', total: '6' },
  { label: 'PG Capit — 8h00-12h45 / 13h30-17h00 — 8,25', poste: 'PG Capit', start: '08:00', end: '17:00', pause: '00:45', total: '8,25' },
  { label: 'Trop Jour — 9h00-13h10 / 13h30-16h15 — 6,92', poste: 'Trop Jour', start: '09:00', end: '16:15', pause: '00:20', total: '6,92' },
  { label: 'Max Ferm — 16h00-19h00 / 19h30-23h30 — 7', poste: 'Max Ferm soir', start: '16:00', end: '23:30', pause: '00:30', total: '7' },
  { label: 'Max Journée — 9h00-14h30 / 16h00-18h00 — 7,5', poste: 'Max Journée 9h14h30', start: '09:00', end: '18:00', pause: '01:30', total: '7,5' },
  { label: 'Bureau 1 — 7h30-12h00 / 12h30-15h00 — 7,00', poste: 'Bureau 1 7h30', start: '07:30', end: '15:00', pause: '00:30', total: '7,00' },
  { label: 'Max Ouv Dim — 7h30-12h00 / 12h30-15h00 — 7,00', poste: 'Max Ouv Dim', start: '07:30', end: '15:00', pause: '00:30', total: '7,00' },
];

const STORAGE_KEY = 'planning-maritime-postes-corrige-v2';

function createEmptyDay() {
  return { guichet: '', poste: '', start: '', end: '', pause: '', manualTotal: '', note: '' };
}
...
export default function App() {
  ...
  function exportCsv() {
    const rows = [
      ['Salarié', ...DAYS.flatMap((day) => [`${day} - Guichet`, `${day} - Poste`, `${day} - Début`, `${day} - Fin`, `${day} - Pause`, `${day} - Total`, `${day} - Note`]), 'Total semaine'],
      ...EMPLOYEES.map((employee) => {
        ...
        return [
          ...
          ...DAYS.flatMap((day) => {
            const cell = planning[employee][day];
            return [cell.guichet, cell.poste, cell.start, cell.end, cell.pause, minutesToHours(calculateDayTotal(cell)), cell.note];
          }),
    ...
    link.href = url;
    link.download = 'planning-maritime-postes.csv';
    link.click();
      ...
      {page === 'planning' && (
        <>
          <section className="toolbar">
            ...
            <span>🏢 Guichet + poste associé aux horaires</span>
              ...
              return (
                <React.Fragment key={employee}>
                  ...
                  {DAYS.map((day) => {
                    ...
                    const isEmpty = !cell.guichet && !cell.poste && !cell.start && !cell.end && !cell.pause && !cell.note;
        ...
        <section className="totals-page">
          ...
          <div className="table-wrapper totals-wrapper">
            <table className="totals-table">
              <thead><tr><th>Salarié</th><th>Jours travaillés</th><th>Total heures</th><th>Détail poste</th></tr></thead>
              <tbody>{weeklyTotals.map((row) => (
                <tr key={row.employee}><th>{row.employee}</th><td>{row.workedDays}</td><td>{minutesToHours(row.totalMinutes)}</td><td>{formatGuichetTotals(row.posteTotals)}</td></tr>
              ))}</tbody>
            </table>
          </div>
        </section>
