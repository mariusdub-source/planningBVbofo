                        ...
                        return rows.map((row) => (
                          <React.Fragment key={`${displayWeekKey}-${employeeIndex}-${row.source}`}>
                            <div className={`sticky-left employee-cell comparison-label ${row.source}`}>
                              ...
                              {isAdmin && row.source === 'actual' && (
                                <label className={`week-validation ${isWeekValidated(employeeIndex, displayWeekKey) ? 'validated' : ''}`} style={{ marginTop: 6 }}>
                                  <input
                                    type="checkbox"
                              ...
                              {isAdmin && row.source === 'actual' && isWeekValidated(employeeIndex, displayWeekKey) && (
