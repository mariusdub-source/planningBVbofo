                ...
                return (
                  <section className="card month-week-card" key={`${displayWeekKey}-${toDateInputValue(firstDate)}`}>
                    ...
                    <div
                      ...
                      style={{ gridTemplateColumns: `minmax(125px, 0.8fr) repeat(${segmentDays.length}, minmax(150px, 1fr)) minmax(90px, 0.55fr)` }}
                    >
            ...
            <section className="card">
              <div className="section-title">
                <div>
                  ...
                  <p>Le mois complet est présenté sous forme de cases, dans le même style que le Planning visuel.</p>
                </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div style={{ paddingTop: 6 }}>
                              {hasShift ? (
                                <div
                                  title={`${shift.counter || 'Poste non renseigné'} ${shift.start || ''}-${shift.end || ''}`}
                                  style={{
                                    width: '100%',
                                    minHeight: 82,
                                    borderRadius: 7,
                                    padding: '8px 9px',
                                    textAlign: 'left',
                                    background: placeColor(shift.counter),
                                ...
                                >
                                  <div style={{ fontSize: 12, fontWeight: 850, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                    {shift.start && shift.end ? `${shift.start} - ${shift.end}` : (shift.note || 'Shift')}
                                  </div>
                                  <div style={{ fontSize: 11, marginTop: 5, fontWeight: 700, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                    {shift.counter || shift.note || 'Non renseigné'}
                                  </div>
                                ...
                                <div style={{ width: '100%', minHeight: 82, background: '#fff', border: '1px dashed #cbd5e1', borderRadius: 7, color: '#94a3b8', fontSize: 11, display: 'grid', placeItems: 'center', boxSizing: 'border-box' }}>—</div>
                              ) : (
